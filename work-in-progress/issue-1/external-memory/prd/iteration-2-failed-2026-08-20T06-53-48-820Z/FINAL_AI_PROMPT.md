...
- Detected files:  ["docker-compose.yml","tests/test_*.py"]
- Manifest exists: false
- Compose path:    docker-compose.yml
- Helm chart path: (none)
- Entrypoint kind: compose
...
**Use `entrypoint.compose.file: docker-compose.yml`** (detected at root of repo).
